        ...
        <div className="container">
            <div className="row">
                ...
                <div className={"col-12 col-md-2 d-flex justify-content-center align-items-center"}>
                    <img className={"img-fluid rounded-circle"} src={ProfileImage} alt="profile"/>
                </div>
                <div className={"col-12 col-md-8 mt-3 mt-md-0"}>
                    <div className="fw-bold">
                        ...
                        <br/>
                        <br/>
                        최근에는 회사에서 개발하다 잦은 구조 변경과 추가되는 요구사항으로 인해 테스트 코드의 중요성과, 왜 객체 지향을 사람들이 많이 강조하는지 느끼게 되어서 책도 읽고, 다른
                        사람들의
                        코드를 보면서 공부하고 있습니다.
                        <br/>
                        <br/>
